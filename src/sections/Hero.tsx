  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto px-5 md:px-10 lg:px-20 py-32 md:py-40 flex flex-col items-center text-center gap-8">
        ...
        {/* Social links */}
        <div className="hero-socials opacity-0 flex items-center justify-center gap-6">
          <a
            href="https://github.com/kevjiang64"
            target="_blank"
            rel="noopener noreferrer"
            className="text-zinc-500 hover:text-white hover:scale-110 transition-all duration-200"
